unit Unit_delphi_xe10_cds_mysql;
...
type
  TForm_delphi_xe10_cds_mysql = class(TForm)
    DBEdit1: TDBEdit;
    DBEdit2: TDBEdit;
    Button1: TButton;
    Button2: TButton;
...
var
  Form_delphi_xe10_cds_mysql: TForm_delphi_xe10_cds_mysql;

implementation

{$R *.dfm}

procedure TForm_delphi_xe10_cds_mysql.Button1Click(Sender: TObject);
begin
CDS_person.Insert;
end;

procedure TForm_delphi_xe10_cds_mysql.Button2Click(Sender: TObject);
begin
CDS_person.ApplyUpdates(1);
end;

procedure TForm_delphi_xe10_cds_mysql.Button3Click(Sender: TObject);
begin
CDS_person.Refresh;
end;

procedure TForm_delphi_xe10_cds_mysql.Button4Click(Sender: TObject);
begin
...
procedure TForm_delphi_xe10_cds_mysql.FormShow(Sender: TObject);
