Unit Unit_delphi_xe2_unidac_mysql;
...
type
  TForm_delphi_xe2_unidac_mysql = class(TForm)
    DBEdit1: TDBEdit;
    DBEdit2: TDBEdit;
    Button1: TButton;
    Button2: TButton;
...
var
  Form_delphi_xe2_unidac_mysql: TForm_delphi_xe2_unidac_mysql;

implementation

{$R *.dfm}

procedure TForm_delphi_xe2_unidac_mysql.Button1Click(Sender: TObject);
begin
Ztbl_person.Insert;
end;

procedure TForm_delphi_xe2_unidac_mysql.Button2Click(Sender: TObject);
begin
Ztbl_person.ApplyUpdates;
end;

procedure TForm_delphi_xe2_unidac_mysql.Button3Click(Sender: TObject);
begin
Ztbl_person.Refresh;
end;

procedure TForm_delphi_xe2_unidac_mysql.Button4Click(Sender: TObject);
begin
...
procedure TForm_delphi_xe2_unidac_mysql.FormShow(Sender: TObject);
