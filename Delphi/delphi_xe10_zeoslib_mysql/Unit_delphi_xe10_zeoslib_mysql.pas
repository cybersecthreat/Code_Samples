unit Unit_delphi_xe10_zeoslib_mysql;
...
type
  TForm_delphi_xe10_zeoslib_mysql = class(TForm)
...
var
  Form_delphi_xe10_zeoslib_mysql: TForm_delphi_xe10_zeoslib_mysql;

implementation

{$R *.dfm}

procedure TForm_delphi_xe10_zeoslib_mysql.Button1Click(Sender: TObject);
begin
ZQuery1.Insert;
end;

procedure TForm_delphi_xe10_zeoslib_mysql.Button2Click(Sender: TObject);
begin
ZQuery1.ApplyUpdates;
end;

procedure TForm_delphi_xe10_zeoslib_mysql.Button3Click(Sender: TObject);
begin
ZQuery1.Refresh;
end;

procedure TForm_delphi_xe10_zeoslib_mysql.Button4Click(Sender: TObject);
begin
...
procedure TForm_delphi_xe10_zeoslib_mysql.FormShow(Sender: TObject);
