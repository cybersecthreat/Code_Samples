object Form_delphi_xe2_cds_mysql: TForm_delphi_xe2_cds_mysql
  Left = 0
  Top = 0
  Caption = 'Form_delphi_xe2_cds_mysql'
  ClientHeight = 507
  ClientWidth = 1233
  Color = clBtnFace
  ...
  object Q_Person: TSQLQuery
    ...
    object Q_Personmy_name: TWideStringField
      FieldName = 'my_name'
      Size = 30
    end
  end
  object SQLConnection_Main: TSQLConnection
    ...
    Params.Strings = (
      'DriverUnit=Data.DBXMySql'
        ...
        'DriverPackageLoader=TDBXDynalinkDriverLoader,DBXMySQLDriver160.b' +
        'pl'
