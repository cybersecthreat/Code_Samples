...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Conn.ConnectionString = ConfigurationManager.ConnectionStrings("VS2013_VB_SQLTest_ConnectionString_By_AppConf.My.MySettings.A_ConnectionString").ConnectionString()
